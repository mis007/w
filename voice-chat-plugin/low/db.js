/**
 * low/db.js - 低配版专用数据库管理
 * 管理低配版的配置和历史记录
 */

class LowSpecDB {
    constructor() {
        this.dbName = 'VoiceChatLowSpecDB';
        this.version = 1;
        this.db = null;
    }
    ...
    async getConfig() {
        ...
        return new Promise((resolve, reject) => {
            ...
            const request = store.get('low_spec_config');
...
// 导出低配版数据库实例
const lowSpecDB = new LowSpecDB();

if (typeof module !== 'undefined' && module.exports) {
    module.exports = { LowSpecDB, lowSpecDB };
} else {
    window.LowSpecDB = LowSpecDB;
    window.lowSpecDB = lowSpecDB;
}