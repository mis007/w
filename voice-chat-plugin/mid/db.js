/**
 * mid/db.js - 中配版专用数据库管理
 * 管理中配版的配置和历史记录
 */

class MidSpecDB {
    constructor() {
        this.dbName = 'VoiceChatMidSpecDB';
        this.version = 1;
        this.db = null;
    }
    ...
    async getConfig() {
        ...
        return new Promise((resolve, reject) => {
            ...
            const request = store.get('mid_spec_config');
...
// 导出中配版数据库实例
const midSpecDB = new MidSpecDB();

if (typeof module !== 'undefined' && module.exports) {
    module.exports = { MidSpecDB, midSpecDB };
} else {
    window.MidSpecDB = MidSpecDB;
    window.midSpecDB = midSpecDB;
}